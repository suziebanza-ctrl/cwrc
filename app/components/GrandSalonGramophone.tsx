...
const tracks: Track[] = [
  ...
  {id: "en-10", category: "english", title: "Rain in My City", artist: "MoonpetalMedia", file: "anglais-10.mp3", source: "https://pixabay.com/music/pop-rain-in-my-city-female-vocals-spanish-acoustic-mood-512147/", license: "Licence Pixabay"},
    ...
    {id: "qc-01", category: "quebec", title: "Bien vite, c’est le jour de l’An", artist: "La Bolduc (Mary Travers)", file: "quebec-01.mp3", source: "https://archive.org/search?query=creator%3A%22La+Bolduc%22", license: "Enregistrement historique — domaine public au Canada"},
  {id: "qc-02", category: "quebec", title: "J’ai un bouton sur la langue", artist: "La Bolduc (Mary Travers)", file: "quebec-02.mp3", source: "https://archive.org/search?query=creator%3A%22La+Bolduc%22", license: "Enregistrement historique — domaine public au Canada"},
  {id: "qc-03", category: "quebec", title: "Rose cherche à se marier", artist: "La Bolduc (Mary Travers)", file: "quebec-03.mp3", source: "https://archive.org/search?query=creator%3A%22La+Bolduc%22", license: "Enregistrement historique — domaine public au Canada"},
  {id: "qc-04", category: "quebec", title: "Les Maringouins", artist: "La Bolduc (Mary Travers)", file: "quebec-04.mp3", source: "https://archive.org/search?query=creator%3A%22La+Bolduc%22", license: "Enregistrement historique — domaine public au Canada"},
  {id: "qc-05", category: "quebec", title: "Toujours L’R-100", artist: "La Bolduc (Mary Travers)", file: "quebec-05.mp3", source: "https://archive.org/search?query=creator%3A%22La+Bolduc%22", license: "Enregistrement historique — domaine public au Canada"},
