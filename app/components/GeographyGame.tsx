...
const text = {
  fr: {
    ...
    oceania: "Océanie",
    countryQuestion:
      "Quel pays est illuminé sur la carte?",
    capitalQuestion:
      "Quelle est sa capitale?",
    flagQuestion:
      "Quel est son drapeau?",
    correct: "Exact!",
    wrong:
  ...
  en: {
    ...
    continent:
      "Small globe: choose a continent",
    africa: "Africa",
    americas: "Americas",
    asia: "Asia",
    europe: "Europe",
  ...
  es: {
    eyebrow:
      "Departamento de Geografía del CWRC",
    title:
      "El desafío de los dos globos",
    intro:
      "Encuentra el país, su capital y luego su bandera. El búho vigila las fronteras con una seriedad totalmente excesiva.",
    world:
      "Globo grande: desafío mundial",
    continent:
      "Globo pequeño: elegir un continente",
    africa: "África",
    americas: "Américas",
    asia: "Asia",
    europe: "Europa",
    oceania: "Oceanía",
    countryQuestion:
      "¿Qué país está iluminado en el mapa?",
    capitalQuestion:
      "¿Cuál es su capital?",
    flagQuestion:
      "¿Cuál es su bandera?",
    correct: "¡Correcto!",
    wrong:
      "No exactamente. La respuesta correcta era:",
...
function FlagIcon({
  ...
  const Flag =
    FlagIcons[
      code as keyof typeof FlagIcons
    ];
